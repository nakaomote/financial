...
def mobilePasumoAll(dirname: str):
...
def mobilePasumoBank(specifyDay: Union[None, str]):
    class Column(str):
    ...
    if specifyDay:
        Select(driver.find_element(By.NAME, "specifyDay")).select_by_visible_text(specifyDay)
